...
def test_pro_user_ids_from_string() -> None:
    ...
    settings = Settings(_env_file=None, pro_user_ids="user-1,user-2,user-3")
...
def test_pro_user_ids_from_string_with_spaces() -> None:
    ...
    settings = Settings(_env_file=None, pro_user_ids=" user-1 , user-2 ")
